...
echo "------------------------"
check_component "Website Compatibility Test" "[ -f 'scripts/test-website-compatibility.js' ]"
check_component "Integration Test" "[ -f 'scripts/test-integration.sh' ]"
check_component "System Verification" "[ -f 'scripts/verify-system.sh' ]"
check_component "Deploy Script" "[ -f 'scripts/deploy.sh' ]"
